...
class RefrigeratorAddViewController: UIViewController {
    ...
    var refrigeratorData: Refrigerator = Refrigerator(refrigeratorName: "", refrigeratorDescription: "", refrigeratorType: "")
    ...
    @objc func saveButtonTapped() {
      ...
      //  guard let refName = refrigeratorData.refrigeratorName , refName != "" else{ return }
        ...
        coreDataManger.saveFridgeData(refID: UUID().uuidString, refName: refrigeratorData.refrigeratorName, refType: refrigeratorData.refrigeratorType, completion: {})
        //냉장고맵 셋팅
...
extension RefrigeratorAddViewController: UICollectionViewDataSource,UICollectionViewDelegateFlowLayout, UICollectionViewDelegate {
