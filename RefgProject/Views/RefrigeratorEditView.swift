...
class RefrigeratorEditView: UIView {
...
"""
     ...
     let fridgeDeleteButton: UIButton = {
        let btn = UIButton()
        btn.translatesAutoresizingMaskIntoConstraints = false
       // btn.setTitle("현재 냉장고 삭제하기", for: .normal)
        // MARK: - 버튼 어트리뷰트(언더라인) 설정

        let attributes: [NSAttributedString.Key: Any] = [
            .font: UIFont(name: "NotoSansKR-Thin_Bold", size: 14)!,
        ...
        btn.titleLabel?.font = UIFont(name: "NotoSansKR-Thin_Bold", size: 14)
...
//        setupUI()
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            scrollView.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor,constant: -45)
        ])
...
//            refTypeLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor)
        ...
        contentView.addSubview(fridgeDeleteButton)
        NSLayoutConstraint.activate([
            fridgeDeleteButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor),
            fridgeDeleteButton.trailingAnchor.constraint(equalTo: contentView.leadingAnchor,constant: 140),
            fridgeDeleteButton.topAnchor.constraint(equalTo: infoLabel.bottomAnchor,constant: 20),
          //  infoLabel.heightAnchor.constraint(equalToConstant: 500),
            fridgeDeleteButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor) //컨텐트뷰의 끝에 걸쳐야함
